...
import WomenFilterShirts from "./WomenFilterShirts";
...
export class MenShirts extends Component {
  ...
  static contextType = WomenShirtsContext;
          ...
          <div className="row w-100">
            <div className="col-6 d-none d-lg-block">
              <div className="row align-items-center">
                <h1 className="d-none d-lg-block col-12">Women's Shirts</h1>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-12 d-lg-block">
              <WomenFilterShirts filterClothes={filterClothes} />
            </div>
