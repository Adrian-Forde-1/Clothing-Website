...
export class MenShoes extends Component {
  ...
  constructor(props) {
    ...
    this.indexOfLastShoe = this.currentPage * this.postPerPage;
    this.indexOfFirstShoe = this.indexOfLastShoe - this.postPerPage;
  ...
  componentDidMount() {
    //Destructor shoes from the context curretly used
    let { menShoes } = this.context;
          ...
          this.setState(
            (prevState, props) => ({
              ...
              filteredClothes: prevState.filteredClothes.filter(shoe => {
                ...
                //If hasSize is greater than or equal to one, that means that the shoe has at least
          ...
          <div className="row w-100">
            <div className="col-6 d-none d-lg-block">
              <div className="row align-items-center">
                <h1 className="d-none d-lg-block col-12">Men's Shoes</h1>
              </div>
            </div>
            ...
            <p className="d-block col-12 col-12 text-right">
              ...
              Items in Men's shoes
            </p>
            <div className="col-lg-3 col-md-12 d-lg-block">
              <MenFilterShoe filterClothes={filterClothes} />
            </div>
            {this.state.currentClothes.length ? (
              ...
              <div>There are no shoes available</div>
            )}
          </div>
          <Pagination
