          ...
          this.setState(
            (prevState, props) => ({
              ...
              filteredClothes: prevState.filteredClothes.filter(jean => {
                ...
                if (jean.sale !== null)
                  return parseFloat(jean.sale) >= parseFloat(lowPrice);
                //If it does not has a sale price, the regular price is compared to the lowPrice entered
                else return parseFloat(jean.price) >= parseFloat(lowPrice);
              })
            }),
            //When the setState is completed, call the sortClothes functions which will sort
            //the array according to the currently selected sort
          ...
          this.setState(
            (prevState, props) => ({
              ...
              filteredClothes: prevState.filteredClothes.filter(jean => {
                ...
                if (jean.sale !== null)
                  return parseFloat(jean.sale) <= parseFloat(highPrice);
                //If it does not has a sale price, the regular price is compared to the lowPrice entered
                else return parseFloat(jean.price) <= parseFloat(highPrice);
              })
            }),
            //When the setState is completed, call the sortClothes functions which will sort
            //the array according to the currently selected sort
          ...
          <div className="row w-100">
            <div className="col-6 d-none d-lg-block">
              <div className="row align-items-center">
                <h1 className="d-none d-lg-block col-12">Men's Jeans</h1>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-12 d-lg-block">
              <MenFilterJeans filterClothes={filterClothes} />
            </div>
