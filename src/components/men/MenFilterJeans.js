...
const MenFilterJeans = (props) => {
  ...
  const expand = (e) => {
    ...
    if (
      ...
      menu.classList.toggle('expandSuperExtra');
          ...
          <div className="smenu">
            <div className="size-holder">
              ...
              <div
                ...
                onClick={filter}
              >
                <p className="lead">32</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">33</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">34</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">35</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">36</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">37</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">38</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">39</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">40</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">41</p>
              </div>
              <div className="w-100 size-filter" id="size" onClick={filter}>
                <p className="lead">42</p>
              </div>
            </div>
          </div>
        </li>
        ...
        <li className="item">
          ...
          <div className="smenu">
            <div className="price-holder">
              ...
              <div className="w-100 price-input-filter" onClick={filter}>
                <input
                  type="number"
                  min="0"
